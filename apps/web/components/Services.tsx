...
export function Services() {
    ...
    const imageData = [
  {
    src: "/marr1.jpg", // replace with real path or public image
    ...
    return (
        <section className="h-full w-auto mt-[0px] md:mt-[30px] ">
            <div className="grid grid-cols-1 md:grid-cols-[45%_53%]  max-w-[1152px]  mx-auto headd ">
                <div>
                    <h1 className="text-4xl  text-center font-bold">Our Exclusive Wedding & Marr<span className="text-orange-300">age</span> <span className="text-orange-400">Services</span></h1>
                </div>
                <div className="sm:ml-[50px] md:mt-0 sm:mt-3 mt-[40px] text-center md:text-start">
                    ...
                    <div className="grid md:grid-cols-2 sm:grid-cols-2 grid-cols-1 gap-7 mt-[45px] ">
                        ...
                        <FaUtensils className="text-orange-400 text-2xl"/>
                            <h1 className="text-3xl font-bold">Catering plan</h1>
                            </div>
                        ...
                        <FaPalette className="text-orange-400 text-2xl"/>
                            <h1 className="text-3xl font-bold">Decor Options</h1>
                            </div>
           ...
           <section className="w-full  mx-auto px-0 sm:px-0 py-16">
      {/* Heading + Description */}
      <div className="text-center mb-10">
        <h2 className="text-3xl sm:text-4xl font-bold text-black mb-4">
         <span className="text-black">Wedding</span>  & Other Moments
        </h2>
